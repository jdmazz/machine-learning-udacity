...
class LearningAgent(Agent):
    ...
    def get_maxQ(self, state):
        ...
        #Note: I'm actually returning the best action for the state, getting the value is less helpful
    ...
    def choose_action(self, state):
        ...
        # The agent object and environment determine which actions
        # are valid. Here we merely choose a random valid action.
